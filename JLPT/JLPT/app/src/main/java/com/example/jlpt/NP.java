...
public class NP extends AppCompatActivity implements View.OnClickListener {
    ...
    private void iniUi(){
        ...
        tvAnswer1=findViewById(R.id.tv_answer12);
        tvAnswer2=findViewById(R.id.tv_answer22);
        tvAnswer3=findViewById(R.id.tv_answer32);
        tvAnswer4=findViewById(R.id.tv_answer42);
    }
